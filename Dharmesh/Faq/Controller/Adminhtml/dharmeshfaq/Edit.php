...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Dharmesh_Faq::Dharmeshfaq')
            ->addBreadcrumb(__('Dharmesh Faq'), __('Dharmesh Faq'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Dharmesh\Faq\Model\Dharmeshfaq');
        ...
        $this->_coreRegistry->register('dharmeshfaq', $model);
